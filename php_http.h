...
#define PHP_HTTP_VERSION "0.1.0" /* Replace with version number for your extension */
...
*/
#define HTTP_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(http, v)

#if defined(ZTS) && defined(COMPILE_DL_HTTP)
